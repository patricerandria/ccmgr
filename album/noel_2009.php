...
$tableau = array();  
$dir = 'album/images/pic_noel_2009/';
$dir_t = "album/images/pic_noel_2009";
$dir_mini = 'album/images/mini_noel_2009/';
...
if ($nbpics != 0) {
	...
	for ($i=0; $i<$nbpics; $i++){
		// noter bien que l'on place un lien vers le fichier mini.php qui va générer nos miniatures. On ajoute un argument, le nom de fichier image à miniaturiser
		 echo '<li><a href="' , $dir , $tableau[$i] , '" title=" "><img src="' , $dir_mini ,'mini_' , $tableau[$i] , '" alt="Image' , $tableau[$i] , '" /></a></li>';
	...
	echo '<dl id="photo">';
    echo '<dt> </dt>';
    echo '<dd><img id="big_pict" src="' , $dir , $tableau[0] , '" alt="Photo 1 en taille normale" /></dd>';
	echo '</dl>';
	//echo '</div>';
}
/*if ($nbpics != 0) { 
